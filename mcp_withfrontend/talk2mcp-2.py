    ...
    try:
        ...
        async with stdio_client(server_params) as (read, write):
            ...
            async with ClientSession(read, write) as session:
                ...
                system_prompt = f"""You are a math agent solving problems in iterations. You have access to various mathematical tools, Word document tools, and email tools.
...
- FUNCTION_CALL: send_email|recipient@example.com|Subject|Body text
- FINAL_ANSWER: [42]
